...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'gozal') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
...
router.get('/randomquote', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://python-api-RadenGozal.herokuapp.com/api/randomquotes`))
...
router.get('/hadits', async (req, res, next) => {
    ...
    if (!nomor) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter nomor"})
       ...
       fetch(encodeURI(`https://hadits-api-RadenGozal.vercel.app/books/${kitab}/${nomor}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/fbdown', async (req, res, next) => {
    ...
    if (!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter url"})
       ...
       fetch(encodeURI(`https://fb-api-RadenGozal.vercel.app/?url=${url}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/tahlil', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/RadenGozal/My-SQL-Results/main/data/dataTahlil.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/wirid', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/RadenGozal/My-SQL-Results/main/data/dataWirid.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/ayatkursi', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/RadenGozal/My-SQL-Results/main/data/dataAyatKursi.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/doaharian', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/RadenGozal/My-SQL-Results/main/data/dataDoaHarian.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/bacaanshalat', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/RadenGozal/My-SQL-Results/main/data/dataBacaanShalat.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatshalat', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/RadenGozal/My-SQL-Results/main/data/dataNiatShalat.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/kisahnabi', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/RadenGozal/My-SQL-Results/main/data/dataKisahNabi.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/asmaulhusna', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/RadenGozal/My-SQL-Results/main/data/dataAsmaulHusna.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatshubuh', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/RadenGozal/My-SQL-Results/main/data/NiatShubuh.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatdzuhur', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/RadenGozal/My-SQL-Results/main/data/NiatDzuhur.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatmaghrib', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/RadenGozal/My-SQL-Results/main/data/NiatMaghrib.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatisya', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/RadenGozal/My-SQL-Results/main/data/NiatIsya.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/niatashar', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/RadenGozal/My-SQL-Results/main/data/NiatAshar.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/cyberspace', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/RadenGozal/My-SQL-Results/main/CyberSpace.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/teknologi', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/RadenGozal/My-SQL-Results/main/Technology.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/muslim', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/RadenGozal/My-SQL-Results/main/Islamic.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/programming', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/RadenGozal/My-SQL-Results/main/Programming.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/pegunungan', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/RadenGozal/My-SQL-Results/main/Mountain.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/jadwalshalat', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/RadenGozal/RadenGozal-Database/main/adzan/${kota}/2021/03.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/fakedata', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://fakename-api-RadenGozal.vercel.app/api/fakename?country=${country}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/hilih', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://hilih-api-RadenGozal.vercel.app/api/hilih?kata=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/liriklagu', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://python-api-RadenGozal.herokuapp.com/api/lirik?search=${lagu}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/chordlagu', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://python-api-RadenGozal.herokuapp.com/api/chord?q=${lagu}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/random/asmaulhusna', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://python-api-RadenGozal.herokuapp.com/api/random/asmaulhusna`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/kbbi', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://kbbi-api-RadenGozal.vercel.app/api/kbbi?text=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/covidindo', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://covid19-api-RadenGozal.vercel.app/api/covid-indonesia`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/covidworld', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://covid19-api-RadenGozal.vercel.app/api/world`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/kodepos', async (req, res, next) => {
	...
	if(!kota) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kota"})
       ...
       fetch(encodeURI(`https://kodepos-api-RadenGozal.vercel.app/?q=${kota}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/news/cnn', async (req, res, next) => {
    ...
    if (!type) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter type"})
       ...
       fetch(encodeURI(`https://news-api-RadenGozal.vercel.app/v1/cnn-news/${type}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/news/cnbc', async (req, res, next) => {
    ...
    if (!type) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter type"})
       ...
       fetch(encodeURI(`https://news-api-RadenGozal.vercel.app/v1/cnbc-news/${type}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/news/republika', async (req, res, next) => {
    ...
    if (!type) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter type"})
       ...
       fetch(encodeURI(`https://news-api-RadenGozal.vercel.app/v1/republika-news/${type}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/news/tempo', async (req, res, next) => {
    ...
    if (!type) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter type"})
       ...
       fetch(encodeURI(`https://news-api-RadenGozal.vercel.app/v1/tempo-news/${type}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/news/antara', async (req, res, next) => {
    ...
    if (!type) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter type"})
       ...
       fetch(encodeURI(`https://news-api-RadenGozal.vercel.app/v1/antara-news/${type}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/news/kumparan', async (req, res, next) => {
	...
	if(apikeyInput != 'gozal') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://news-api-RadenGozal.vercel.app/v1/kumparan-news`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/yutub/video', async (req, res, next) => {
    ...
    if (!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter url"})
       ...
       fetch(encodeURI(`https://python-api-RadenGozal.herokuapp.com/api/ytv?url=${url}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/yutub/audio', async (req, res, next) => {
    ...
    if (!url) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter url"})
       ...
       fetch(encodeURI(`https://python-api-RadenGozal.herokuapp.com/api/yta?url=${url}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/ig/stalk', async (req, res, next) => {
    ...
    if (!username) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter username"})
       ...
       fetch(encodeURI(`https://python-api-RadenGozal.herokuapp.com/api/stalk?username=${username}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
